...
export const projects: Project[] = [
  ...
  {
    id: 4,
    title: "Artisan Shop E-commerce",
    shortDescription: "Handcrafted goods marketplace",
    description: "Custom e-commerce platform for artisanal handcrafted products",
    longDescription: "Artisan Shop is a specialized e-commerce platform that connects artisans with customers seeking unique, handcrafted products. The platform features a robust product management system, secure payment processing, and a customizable storefront that showcases the unique story behind each artisan and their craft.",
    category: "web",
    image: "https://images.unsplash.com/photo-1571781926291-c477ebfd024b?ixlib=rb-1.2.1&auto=format&fit=crop&w=600&h=400&q=80",
    tags: ["Next.js", "Stripe", "MongoDB"],
    technologies: ["Next.js", "React", "MongoDB", "Stripe API", "AWS S3", "Vercel", "Tailwind CSS"],
    demoUrl: "https://example.com/artisan-demo",
    githubUrl: "https://github.com/zonebrozstudios/artisan-shop",
  },
  {
    id: 5,
